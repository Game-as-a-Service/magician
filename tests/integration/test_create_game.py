...
def test_players_name():
    ...
    assert players.get_group_names() == except_input_name
...
def test_players_seat():
    ...
    for player, seat in zip(except_input_name, except_input_seat):
        ...
        player_seat.set_player_seat(seat)

    assert player_seat.get_all_players_seat(except_input_name) == except_input_seat
...
def test_players_HP():
    ...
    for player, hp in zip(except_input_name, except_input_hp):
        ...
        player_hp.set_player_hp(hp)

    assert player_hp.get_all_players_hp(except_input_name) == except_input_hp
...
def test_players_score():
    ...
    for player, score in zip(except_input_name, except_input_score):
        ...
        player_score.set_player_score(score)

    assert player_score.get_all_players_score(except_input_name) == except_input_score
